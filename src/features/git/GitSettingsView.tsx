      ...
      <div class="max-w-3xl mx-auto flex flex-col pb-12">
        ...
        <section class="mb-8">
          ...
          <div class="flex justify-end pt-4">
            <Button onClick={git.handleSaveConfig} variant="primary">Save Identity</Button>
          </div>
        </section>
        ...
        <section class="mb-8">
          ...
          <Show when={git.remotes()?.length === 0}>
            <div class="py-4 border-b border-[var(--color-border)]">
              <span class="text-sm italic" style={{ color: "var(--color-fg-muted)" }}>No remotes configured.</span>
            </div>
          </Show>
            ...
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1 flex gap-2">
                <Input 
                  ...
                  class="w-full"
                />
                <Button onClick={git.handleAddRemote} disabled={!git.newRemoteName() || !git.newRemoteUrl()} class="shrink-0">
                  Add Remote
                </Button>
              </div>
            </div>
        ...
        <section class="mb-8">
          ...
          >
            <CustomSelect
              ...
              onChange={(v) => git.setCredentialHelperConfig(v === "none" ? "" : v)}
              options={[
          ...
          <div class="py-4 text-sm leading-relaxed" style={{ color: "var(--color-fg-muted)" }}>
            <p class="mb-2"><strong class="text-[var(--color-fg)]">SSH Keys:</strong> To authenticate via SSH, ensure your remote URL starts with <code>git@</code> (e.g. <code>git@github.com:user/repo.git</code>). Git will automatically use the keys located in your <code>~/.ssh/</code> directory.</p>
          </div>
        </section>
